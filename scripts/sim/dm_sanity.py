...
amp_large = 5.0
intensity_sum_plot(
    focal_wavefront(3, amp_large), 
    focal_wavefront(6, amp_large)
)
...
amp_small = 1.2
intensity_sum_plot(
    focal_wavefront(3, amp_small), 
    focal_wavefront(6, amp_small)
)
...
# %%
truth = Wavefront(focal_wavefront(2, amp_large).electric_field + focal_wavefront(3, amp_large).electric_field)
...
# %%
# Then the small:
truth = Wavefront(focal_wavefront(2, amp_small).electric_field + focal_wavefront(3, amp_small).electric_field)
recon = prop.backward(truth)
imshow_field(recon.phase * aperture, mask=aperture)
