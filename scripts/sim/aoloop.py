...
ao_config = {
    ...
    "Cn_squared" : hcipy.Cn_squared_from_fried_parameter(0.12), # the parameter is the Fried parameter in meters; vary this from 0.05 (really bad) to 0.2 (really good)
...
pwfs = hcipy.PyramidWavefrontSensorOptics(pupil_grid, pwfs_grid, separation=60/56, pupil_diameter=ao_config["D"], wavelength_0=ao_config["wavelength"], q=10)
...
def create_closed_loop_animation():
    ...
    def animate(t):
        ...
        deformable_mirror.actuators = (1-ao_config["leak"]) * deformable_mirror.actuators - ao_config["gain"] * CM.dot(diff_image)
